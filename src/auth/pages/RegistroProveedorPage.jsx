...
const RegistroProveedorPage = () => {
  ...
  const validateForm = async () => {
    ...
    if (!formData.Nombre) {
      newErrors.Nombre = "Nombre/Empresa es requerido";
    ...
    if (!formData.Identificacion) {
      ...
      newErrors.Identificacion = "Formato de cédula/RUC inválido";
    }
  ...
  const handleSubmit = async () => {
    try {
      ...
      const { ContrasenaConf, ...payload } = formData;
      ...
      // Los proveedores envían una solicitud de registro que debe ser aprobada
      ...
      Alert.alert(
        "¡Solicitud Enviada!",
        "Tu solicitud de registro ha sido enviada correctamente. Un administrador la revisará pronto y te notificaremos por email.",
        [
          {
            text: "Entendido",
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <StyledText color="textGray" fontSize="body" style={styles.subtitle}>
              Completa tus datos para solicitar tu cuenta
            </StyledText>
          </View>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.inputGroup}>
              <StyledText style={styles.label}>
                Nombre / Empresa <StyledText style={styles.required}>*</StyledText>
              </StyledText>
              <StyledTextInput
